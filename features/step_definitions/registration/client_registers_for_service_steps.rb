...
And(/^The appointment will not overlap with an appointment that already exists$/) do
  pending # Write code here that turns the phrase above into concrete actions
end

When(/^I register for an appointment$/) do
  pending # Write code here that turns the phrase above into concrete actions
end

Then(/^I will receive a message saying that the registration was successful$/) do
  pending # Write code here that turns the phrase above into concrete actions
end